<template>
  <div v-if="show" class="fixed inset-0 flex items-center justify-center z-50">
    <div
      ...
      <form class="flex flex-col w-12/12 space-y-4 p-5 overflow-y-auto max-h-[600px]"
        @submit.prevent="addProductVariation" method="POST ">
        ...
        <div class="flex space-x-4">
          <label class="block w-6/12">
            ...
            <input type="input" name="shape" v-model="productVariationData.shape"
              class="mt-2 px-2 py-2 bg-white border border-1 shadow-sm border-mid-gray-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-xl sm:text-sm focus:ring-1"
              placeholder="Shape" />
          </label>
          <label class="block w-6/12">
            ...
            <input type="input" name="markings" v-model="productVariationData.markings"
              class="mt-2 px-2 py-2 bg-white border border-1 shadow-sm border-mid-gray-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-xl sm:text-sm focus:ring-1"
...
export default {
  ...
  data() {
    return {
      headerTitle: "Product Variation Registration",
  ...
  watch: {
    product: {
      immediate: true,
      handler(newValue) {
        this.productVariationData.product_id = newValue.id
        this.productVariationData.product_category_id = newValue.product_category_id
        this.productVariationData.product_name = newValue.product_name
        this.productVariationData.generic_name_id = newValue.generic_name_id
        this.productVariationData.dosage_form_id = newValue.dosage_form_id
        this.productVariationData.therapeutic_category_id = newValue.therapeutic_category_id
        this.productVariationData.color = newValue.color
        this.productVariationData.shape = newValue.shape
        this.productVariationData.markings = newValue.markings
        this.productVariationData.scheduling_status = newValue.scheduling_status
        this.productVariationData.strength = newValue.strength
        this.productVariationData.administration_route_id = newValue.administration_route_id
        this.productVariationData.unit_dose = newValue.unit_dose
        this.productVariationData.package_size = newValue.package_size
        this.productVariationData.package_type = newValue.package_type
