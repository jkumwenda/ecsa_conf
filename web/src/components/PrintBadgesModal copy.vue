            ...
            <div id="badge-container">
                <div v-for="(page, pageIndex) in paginatedParticipants" :key="pageIndex" class="badge-page">
                    <div class="grid sm:grid-cols-2 grid-cols-1 gap-4">
                        <div v-for="(participant, index) in participant" :key="index"
                            class="border border-abbey-100  flex flex-col justify-center text-center"
                            ...
                            <div class="flex flex-col items-center">
                                <div
                                    class="bg-bondi-blue-500 px-4 pb-4 font-bold text-white rounded-md text-md uppercase">
