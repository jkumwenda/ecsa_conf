<template>
    <div
        ...
        <div class="flex sm:flex-row">
            <router-link :to="{ name: 'Home' }"><img src="@/assets/images/50years.png" class=" h-20"></router-link>
        </div>
        <div class="flex flex-row items-center justify-between space-x-4">
            <!-- <router-link :to="{ name: 'Login' }" class="text-abbey-400">All events
            </router-link> -->
            <router-link :to="{ name: 'Login' }"
                class="px-8 py-3 text-white-50 rounded-2xl bg-bondi-blue text-stone-100 hover:bg-bondi-blue-600">Sign
                In
            </router-link>
