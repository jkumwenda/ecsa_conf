                ...
                <div class="flex flex-col w-full space-y-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div v-else class="flex flex-col px-4 items-center justify-center">
                            ...
                            <div class="px-1 italic text-sm text-bondi-blue" v-if="message">{{ message }}</div>
                            <form @submit.prevent="confirmPayment" method="POST"
                                class="sm:w-12/12 bg-bondi-blue-100 border-2 border-abbey-400 p-2 px-6 rounded-xl my-4">
                                <span class="text-sm font-bold">Enter key to confirm payment</span>
                                ...
                                <button type="submit"
                                    class="mt-2 px-4 py-1 text-sm text-white-100 bg-bondi-blue hover:bg-bondi-blue-400 rounded-md">
                                    Confirm Payment
                                </button>
                            </form>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async confirmPayment() {
            ...
            this.message = "Invalid key, only secretariat can confirm payment"
        },
